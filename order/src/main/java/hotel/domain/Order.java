...
import hotel.OrderApplication;
import hotel.domain.OrderCancelled;
import hotel.domain.OrderPlaced;
...
public class Order {
    ...
    //>>> Clean Arch / Port Method
    //<<< Clean Arch / Port Method
    public static void updateStatus(DeliverCompleted deliverCompleted) {
        //implement business logic here:
        ...
        */
        ...
        repository().findById(deliverCompleted.get???()).ifPresent(order->{
